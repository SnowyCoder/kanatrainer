...
DIGRAPHS_ALPHABET = {
  "k": ["きゃ", "きゅ", "きょ", "っか", "っき", "っく", "っけ", "っこ", "っきゃ", "っきゅ", "っきょ"],
  "s": ["しゃ", "しゅ", "しょ", "っさ", "っし", "っす", "っせ", "っそ", "っしゃ", "っしゅ", "っしょ"],
  "t": ["ちゃ", "ちゅ", "ちょ", "った", "っち", "っつ", "って", "っと", "っちゃ", "っちゅ", "っちょ"],
  "n": ["にゃ", "にゅ", "にょ"],
  "h": ["ひゃ", "ひゅ", "ひょ"],
  "m": ["みゃ", "みゅ", "みょ"],
  "r": ["りゃ", "りゅ", "りょ"],
...
DIGRAPHS_DIATRICS_ALPHABET = {
  ...
  "h": ["びゃ", "びゅ", "びょ", "ぴゃ", "ぴゅ", "ぴょ", "っぱ", "っぴ", "っぷ", "っぺ", "っぽ", "っぴゃ", "っぴゅ", "っぴょ"],
};
